...
export function ListingBoardContainer({
  ...
  return (
    <div className="board-container space-y-6">
      ...
      {/* Filter Ticket Card */}
      <section className="filter-ticket rounded-2xl border border-[var(--manila-dark)]/40 bg-[var(--paper-bright)] p-5 shadow-lg backdrop-blur-xs">
        <form method="get" className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-6 items-end">
          ...
          <div className="lg:col-span-2">
            ...
            <input
              ...
              className="mt-1 w-full rounded-xl border border-[var(--line)] bg-[var(--paper)] px-3.5 py-2 text-sm text-[var(--ink)] shadow-xs transition-colors focus:border-[var(--found)] focus:bg-white"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              name="from"
              defaultValue={from}
              className="mt-1 w-full rounded-xl border border-[var(--line)] bg-[var(--paper)] px-3 py-2 text-sm text-[var(--ink)] shadow-xs transition-colors focus:border-[var(--found)]"
            />
          </div>

          <div>
            <button
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-[var(--manila)]/40 hover:bg-[var(--manila)]/70 px-4 py-2.5 text-sm font-bold text-[var(--ink)] shadow-xs transition-all active:scale-95 cursor-pointer"
              type="submit"
            >
        ...
        {profile?.college_id && (
          <form className="outside-toggle mt-4 flex items-center justify-between pt-3 border-t border-[var(--line)]/50 text-xs text-[var(--muted-ink)]" action={toggleOutsideAction}>
            ...
            <button
              type="submit"
              className={`rounded-full px-3 py-1 font-mono text-[0.7rem] font-bold uppercase tracking-wider transition-all cursor-pointer ${
                profile.show_independent_posts
                  ? "bg-[var(--found)] text-white shadow-xs"
                  : "bg-[var(--paper)] text-[var(--muted-ink)] border border-[var(--line)]"
              }`}
      ...
      {cards.length ? (
        ...
        <section className="empty-board rounded-2xl border border-dashed border-[var(--manila-dark)]/50 bg-[var(--paper-bright)] p-12 text-center shadow-xs">
